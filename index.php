...
<body>
    <div class="hero">
        ...
        <div class="detel">
            <h1>I,M Elgantouri <span>Hicham</span></h1>
            <p>This is my official Portfolio website to showcase my 
                all works related to <br> web development and ui design. </p><br><br>
            <!-- <a href="#">Downdload CV</a> -->
        </div>
        <div class="images">
            <img src="images/shape.png" class="shape">
            <img src="images\SH-fococlipping-standard.png" class="girl">
        </div>
